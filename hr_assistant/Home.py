...
from helpers import (add_policies, cache_load_policies, create_chatbot,
                     fake_streaming_response, tidy_title)
...
policies = cache_load_policies("./Policies")
...
with chat_col:
    ...
    if prompt:
        ...
        st.chat_message("assistant", avatar = AVATAR).write_stream(fake_streaming_response(chatbot_response))
